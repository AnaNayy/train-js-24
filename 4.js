...
function task4() {
  ...
  // Після 1 секунди викликаємо функцію resolve, яка змінює стан проміса на
  //"виконано" і передає значення 'Проміс 1 виконано'
  ...
  // Після 1 секунди викликаємо функцію resolve, яка змінює стан проміса на "виконано" і
  //  передає значення 'Проміс 2 виконано'
